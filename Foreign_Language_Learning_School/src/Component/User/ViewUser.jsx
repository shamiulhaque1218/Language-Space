...
import { faChalkboardTeacher, faUserShield } from "@fortawesome/free-solid-svg-icons";
      ...
      <table className="table table-compact w-full">
        ...
        {tqData.map((data,index) => (
          ...
          <td className="p-3 text-center">  {index+1} </td>
            <td >
              <img className="h-12 w-12 ml-8 rounded-xl" src={data.photoURL} alt="" />
            </td>
            ...
            <div>
             
                {
                  ...
                  <FontAwesomeIcon className='h-4 text-white' icon={faUserShield} />
                  </button> : <button
                onClick={() => handelAddAdmin(data._id)}
                ...
                }
                {
                  ...
                  className="btn px-3 py-3 bg-blue-500 text-center" disabled>
                <FontAwesomeIcon className='h-4 text-white' icon={faChalkboardTeacher} />
                </button> :
                <button
                onClick={() => handelAddInstructor(data._id)}
